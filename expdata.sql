...
-- Дата скрипта: 05.06.2022 21:18:39
...
INSERT INTO sklad.roles(id, name, url) VALUES
(4, 'admin', '/admin/'),
(3, 'Buxgalter', '/bux/'),
(1, 'Kuriyer', '/api/'),
(6, 'Mehmon', '/site/index/'),
...
INSERT INTO sklad.users(id, name, email, email_verified_at, password, remember_token, created_at, updated_at, role_id) VALUES
